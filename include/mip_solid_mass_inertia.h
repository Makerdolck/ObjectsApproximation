...
public :
  ...
  double inertia[SPACE_DIM];            ///< \ru Статические моменты. \en Static moments. 
  double initial[SPACE_DIM][SPACE_DIM]; ///< \ru Моменты инерции относительно исходных осей координат. \en Moments of inertia relative to source coordinate axes. 
  double moments[SPACE_DIM][SPACE_DIM]; ///< \ru Моменты инерции относительно центральных осей координат. \en Moments of inertia relative to central coordinate axes. 
  double general[SPACE_DIM];            ///< \ru Главные центральные моменты инерции. \en Principal central moments of inertia. 
  MbCartPoint3D center;                 ///< \ru Центр тяжести. \en Center of gravity. 
  MbVector3D direction[SPACE_DIM];      ///< \ru Векторы направлений главных центральных осей инерции. \en Direction vectors of the principal central axes of inertia. 
...
public:
  ...
  */
  ...
  /** \brief \ru Определить массо-центровочных характеристики.
    ...
    интегрирование выполяется с помощью квадратурных формул Гаусса. 
  ...
  */
  ...
  /** \brief \ru Определить массо-центровочных характеристики.
    ...
    \param[in] calculateAll - \ru Если false, проводится расчет интегралов инерции,\n
                              если true, то еще проводится 
                              расчет центра масс, центральных моментов инерции,
                              главных центральных моментов инерции.
                              \en If false, then performs integrals of inertia calculation,\n
                              if true, then performs also 
                              calculation of center of mass, central moments of inertia,
...
public:
 ...
 /// \ru Плотность тела. \en A solid density. 
  ...
  /** \brief \ru Расчёт аддитивных характеристик тела.
    ...
    \param[in]  deviateAngle - \ru Параметр управления точностью расчёта - угловое отклонение нормпли поверхности или касательных кривой на участке численного интегрирования.
                               \en Tolerance - the angular deviation of surface or curve in the neighboring points on the region of numerical integration. \~
    \param[out] mp           - \ru Расcчитанные инерционные характеристики с учётом пользовательских данных.
...
//------------------------------------------------------------------------------
/** \brief \ru Вычисление массо-центровочных характеристик.
           \en Calculation of mass-inertial properties. \~
  \details \ru Вычисление массо-центровочных характеристик тела.
  ...
  \param[in]  deviateAngle - \ru Параметр управления точностью расчёта - угловое отклонение нормпли поверхности или касательных кривой на участке численного интегрирования.
                             \en Tolerance - the angular deviation of surface or curve in the neighboring points on the region of numerical integration. \~
  \param[out] mp           - \ru Расчитанные инерционные характеристики.
...
/** \brief \ru Вычисление массо-центровочных характеристик.
           \en Calculation of mass-inertial properties. \~
  \details \ru Вычисление массо-центровочных характеристик тел.
  ...
  \param[in]  matrs        - \ru Матрицы преобразования тел.\n
                             Количество элементов в массиве должно совпадать с количеством тел.
                             \en Matrices of solids transformation.\n
                             Count of elements in array must be equal to count of solids. \~
...
/** \brief \ru Вычисление массо-центровочных характеристик.
           \en Calculation of mass-inertial properties. \~
  \details \ru Вычисление массо-центровочных характеристик сборки.
