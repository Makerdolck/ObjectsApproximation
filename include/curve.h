...
public :
  ...
  */
  ...
  /// \ru Построить кривую, смещённую на заданное расстояние. \en Construct the curve which is shifted by the given value. 
  ...
  */
  ...
  /// \ru Определить, являются ли кривая инверсно такой же. \en Define whether an inversed curve is the same. 
          bool        IsInverseSame( const MbCurve & curve ) const;
