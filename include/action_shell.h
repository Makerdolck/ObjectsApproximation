...
/** \brief \ru Проверить кривую для построения линейчатого тела.
  ...
  \warning \ru Вспомогательная функция операции RuledShell.
           \en An auxillary function of operation 'RuledShell'. \~
  \ingroup Shell_Modeling
*/
//---
...
/** \brief \ru Проверить кривую для построения тела соединения.
  ...
  \warning \ru Вспомогательная функция операции JoinShell.
           \en An auxillary function of operation JoinShell. \~
  \ingroup Shell_Modeling
*/
//---
...
/** \brief \ru Определение оси токарного сечения и построение кривых сечения для тела.
  ...
  \param[in]  angle    - \ru Угол, управляющий построением перпендикулярных оси сечения отрезками, рекомендуеися M_PI_4-M_PI. \en The angle, managing the construction of segments which perpendicular to the axis, recomended M_PI_4-M_PI. \~ 
  ...
  \param[out] curves   - \ru Кривые токарного сечения равполагаются в плоскости XY position. \en The curves of section located on plane XY of position. \~
  \return \ru Возвращает код результата операции.
          \en Returns operation result code. \~
  \ingroup Shell_Modeling
*/
...
MATH_FUNC( MbResultType ) MedianShell(       MbSolid &                        solid,
                                             MbeCopyMode                      sameShell,
                                       const std::vector< c3d::NumberPair > & faceIndexes,
