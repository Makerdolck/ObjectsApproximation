...
private:
  ...
  void         _NewCapacity( size_t max_len, bool clear );
};
...
SQueue<Type>::SQueue( size_t capacity )
  : data( capacity > 0 ? new Type[capacity]:NULL )
  , qlast( NULL )
  , qp1( NULL )
  , qp2( NULL )
{ 
...
// ---
template <class Type>
void SQueue<Type>::_NewCapacity( size_t max_len, bool clear ) 
{
