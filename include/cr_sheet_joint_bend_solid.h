...
class MATH_CLASS MbJointBendSolid : public MbCreator {
  ...
  PArray< PArray<MbSMBendNames> > bendsParams;  ///< \ru Множество параметров для каждого формируемого сгиба. \en Set of parameters for each bend. 
...
public :
  MbJointBendSolid( const MbPlacement3D &                   placement,
                    ...
                    const PArray< PArray<MbSMBendNames> > & bendsParams,
