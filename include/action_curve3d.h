...
/** 
  ...
  \details \ru На базе кривых строятся рёбра. Рёбра используются в твёрдотельной и каркасной модели. 
    ...
    as auxillary elements of a model. \~
...
//------------------------------------------------------------------------------
/** \brief \ru Создать сечение кинематического тело для заданного параметра на направляющей.
           \en Create a section of evolution solid for defined parameter on the guide curve. \~
  \details \ru Создать сечение кинематического тело для заданного параметра на направляющей. 
