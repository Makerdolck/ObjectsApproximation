...
public:
  ...
  virtual MbeImpExpFormat GetFormat       () const { return ief_STEP203; }
...
namespace c3d {
  ...
  \ingroup Exchange_Interface
  */
  CONV_FUNC (MbeConvResType ) ImportFromFile( MbModel& model, const path_string& fileName, IConvertorProperty3D * prop = 0 , IProgressIndicator * indicator = 0 );
  ...
  \ingroup Exchange_Interface
  */
  CONV_FUNC (MbeConvResType ) ExportIntoFile( MbModel& model, const path_string& filePath, IConvertorProperty3D * prop = 0 , IProgressIndicator * indicator = 0 );
  ...
  \ingroup Exchange_Interface
  */
  CONV_FUNC (MbeConvResType ) ImportFromBuffer( MbModel& model, const char* data, size_t length, MbeModelExchangeFormat modelFormat, IConvertorProperty3D * prop = 0 , IProgressIndicator * indicator = 0 );
};
