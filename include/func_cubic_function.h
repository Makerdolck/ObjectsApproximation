...
protected:
  ...
  SArray<double> firstList;  ///< \ru Производные в характерных точках. \en The derivatives in control points. 
...
public:
  ...
  virtual MbFunction * BreakFunction( double t, bool beg );
          ...
          // \ru В указаттой точке t установить заданное поведение, изменив функцию на интервале, не превышающем tDelta. \en Set a given behavior at point t by modifying the function of an interval not exceeding tDelta.
