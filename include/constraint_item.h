...
/** 
  \file
  \brief \ru Модуль: CONSTRAINT_ITEM
         \en Module: CONSTRAINT_ITEM. \~
...
public:
  ...
  SPtr<MbRefItem>     m_item;    ///< \ru Объект модели \en The model object 
...
public:
  ...
  { 
    PRECONDITION( false ); // Неполная реализация класса
