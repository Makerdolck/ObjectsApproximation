...
// ---
enum MbeState {
  dp_NoChanged,   ///< \ru Объект не изменился. \en The object is not changed.
...
enum MbeStepType {
  ...
  ist_ParamStep     =  0x08, ///< \ru Шаг для для привязки объектов к параметрам поверхности. \en Step for linking with surface parameters. 
