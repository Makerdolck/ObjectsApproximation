...
public :
  ...
  */
  ...
  void        Init( const Point & p ) { x = p.x; y = p.y; z = p.z; }
...
//------------------------------------------------------------------------------
/** 
  \brief \ru Проверка равенства точек с заданной точностью.
         \en The check for equality with a given tolerance. \~
  ...
  \param[in] p1 - \ru Точка 1.
                  \en A point 1. \~
  \param[in] p2 - \ru Точка 2.
                  \en A point 2. \~
...
*/
// ---
inline bool EqualPoints( const MbCartPoint3D & p1, const MbCartPoint3D & p2, double eps ) {
