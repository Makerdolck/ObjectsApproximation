...
protected :
  ...
  MbIdentifier( const MbIdentifier & init ); 
public :
  /// \ru Конструктор. \en Constructor. 
...
private:
  std::vector<MbNameAttribute *> parentNames; ///< \ru Топологические имена родителей объекта. \en Topological names of object parents. 
  // \ru Родительские имена не пишутся и не читаются, пока на время рабочего сеанса. \en Names of parents are not read and written at the working session. 
...
protected :
  /// \ru Конструктор копирования. \en Copy constructor. 
  MbUpdateStamp( const MbUpdateStamp & init ); 
public :
  /// \ru Конструктор. \en Constructor. 
  MbUpdateStamp();
  /// \ru Конструктор. \en Constructor. 
