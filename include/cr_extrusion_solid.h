...
public :
  /** \brief \ru Конструктор.
    ...
    \param[in] direction_    - \ru Направление выдавливания.
                               \en An extrusion direction. \~
    \param[in] parameters_   - \ru Параметры выдавливания.
  ...
  */
  MbCurveExtrusionSolid( const MbSweptData &          sweptData_,
                         const MbVector3D &           direction_,
                         const ExtrusionValues &      parameters_, 
                               OperationType          oType, 
                         const MbSNameMaker &         operNames, 
                         const PArray<MbSNameMaker> & contoursNames,
                         const RPArray<MbCreator>   * creators_ = NULL,
...
/** \brief \ru Создать оболочку тела выдавливания.
  ...
  \param[in]       creators       - \ru Cтроители тела solid.
