...
public:
  MbBooleanSolid( const MbCreator &          solid2, bool sameCreators2, 
                  OperationType operType, 
                  const MbBooleanFlags & booleanFlags, 
                  const MbSNameMaker & n );

  MbBooleanSolid( const RPArray<MbCreator> & solid2, bool sameCreators2, 
                  OperationType operType, 
                  const MbBooleanFlags & booleanFlags, 
                  const MbSNameMaker & n );

  MbBooleanSolid( const RPArray<MbCreator> & solids12, size_t firstCount, bool sameCreators1, bool sameCreators2,
                  OperationType operType, 
                  const MbBooleanFlags & booleanFlags,
                  const MbSNameMaker & n );
private :
