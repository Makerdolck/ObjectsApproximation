...
{ 
  ...
  GCE_ARC,              ///< \ru Отрезок окружности. \en Circle segment.
  GCE_ELLIPSE_ARC,      ///< \ru Отрезок эллипса. \en Ellipse segment.
...
{ 
  ...
  , GCE_UNKNOWN_CON = GCE_CONSTRAINTS_COUNT ///< \ru Неизвестный тип ограничения. \en Unknown constraint type.
} constraint_type;
...
struct GCE_dim_pars
{
  bool      isDriving;     // Deprecated. Now a condition var == GCE_NULL_V means that the dimension is driving.
  bool      isInformation; // deprecated
...
struct GCE_diagnostic_pars
{
  ...
  double  reductCoef; // An index of reduction of constraint system as result of internal decomposition methods.
...
const GCE_bisec_variant bv_NormalSum = GCE_BISEC_MINUS; ///< \ru Биссектриса вдоль суммы нормалей прямых/отрезков. \en Bisector along the sum of normals of lines/segments.
const GCE_bisec_variant bv_NormalDiff = GCE_BISEC_PLUS; ///< \ru Биссектриса вдоль разности нормалей прямых/отрезков. \en Bisector along difference of normals of lines/segments.
