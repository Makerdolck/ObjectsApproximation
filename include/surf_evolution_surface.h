...
/** 
  \file
  \brief \ru Кинематическая поверхность.
         \en The evolution surface. \~
...
*/
// ---
MATH_FUNC (MbSurface &) CreateEvolutionSurface( const MbCurve3D & curve, const MbSpine & spine, bool samec );
