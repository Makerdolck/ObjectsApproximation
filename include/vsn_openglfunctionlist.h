...
#ifndef __VSN_GLFUNCTIONLIST_H
#define __VSN_GLFUNCTIONLIST_H
...
class OpenGLFunctionListPrivate;
...
*/
// ---
class VSN_CLASS OpenGLFunctionList
{
public:
  enum GLProperties
  {
...
public:
  OpenGLFunctionList();
  explicit OpenGLFunctionList(OpenGLContext* context);
  ~OpenGLFunctionList() {}
...
protected:
  static bool isInitialized(const OpenGLFunctionListPrivate* d) { return d != 0; }
protected:
  VSN_DECLARE_PRIVATE(OpenGLFunctionList)
};
