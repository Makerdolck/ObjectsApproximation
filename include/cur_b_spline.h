...
public:
  ...
  virtual void    CalculateWire( const MbStepData & stepData, MbMesh & mesh ) const;  // \ru Рассчитать сетку для отображения в модели \en Calculate mesh for mapping in model 
