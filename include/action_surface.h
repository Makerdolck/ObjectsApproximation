...
*/
// ---
MATH_FUNC (MbResultType) OffsetSurface( MbSurface & surface, double distance, 
                                        MbSurface *& result );
...
*/
// ---
MATH_FUNC (MbResultType) DeformedSurface( MbSurface & surface, size_t uCount, size_t vCount,
                                          size_t uDegree, size_t vDegree, double dist, MbSurface *& result);
