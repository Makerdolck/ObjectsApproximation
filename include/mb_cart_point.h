...
public :
  ...
  */
  ...
  void        Init( const Point & p ) { x = p.x; y = p.y; }
  /// \ru Инициализировать по координатам. \en Initialize by coordinates. 
  void        Init( double initX, double initY ) { x = initX; y = initY; }
...
*/ 
// ---
inline void Swap( MbCartPoint & p1, MbCartPoint & p2 )
{
  double tmp;
...
*/ 
// ---
inline bool EqualPoints( const MbCartPoint &p1, const MbCartPoint & p2, double eps ) {
...
*/
// ---
inline bool EqualPoints( const MbCartPoint & p1, const MbCartPoint & p2, double xEpsilon, double yEpsilon ) {
...
*/
//---
inline bool EqualLengths( double lx, double ly,
                          double minLen = METRIC_EPSILON, double minDev = LENGTH_EPSILON )
{
