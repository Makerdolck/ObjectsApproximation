...
//////////////////////////////////////////////////////////////////////////////////////////
/**
  \attention The interface will be removed in one of the next versions (2014).
*/
//////////////////////////////////////////////////////////////////////////////////////////

struct ItGeomConstraintSolver : public MtRefItem
{  
private:
  /**
  ...
  */
  virtual geom_item AddGeom( IfGeom2d & ) = 0;
  /**
    \attention \ru Устаревшая функция. Вызов будет удален в одной из следующих версий.
    \en An obsolete function. The call will be removed in one of the next versions. \~
  */
  virtual bool      IsFixedGeom( geom_item ) const = 0;
...
/**
  \attention \ru Устаревшая функция. Вызов будет удален в одной из следующих версий (2014).
  \en An obsolete function. The call will be removed in one of the next versions. \~
*/
GCE_FUNC(ItGeomConstraintSolver*) CastToIfPtr( GCE_system );
