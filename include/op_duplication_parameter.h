...
/** \brief \ru Типы параметров размножения.
  ...
  \details \ru dt_Grid - Копии располагаются в узлах декартовой сетки, заданной двумя направлениями, 
               ...
               вектором оси вращения, шагом по лучу, углом поворота, кол-вом шагов по лучу и угловых шагов,
                  ...
                  O       O   \n
                   \     /    \n
                    O   O     \n
                     \ /      \n
                O--O-[O]-O--O \n
                dt_Matrix - Parameters of duplication is array of matricies. Numder of copies equal to numder of matrix.
  ...
  */
  ...
  /** \brief \ru Построить копию объекта.
    ...
    \details \ru Построить копию объекта. \n
             \en Create a copy of the object. \n \~
  */
  virtual DuplicationValues & Duplicate( MbRegDuplicate * ireg = NULL ) const = 0; 
...
/** \brief \ru Размножение по сетке.
  ...
  \details \ru Параметры размножение по размножение по декартовой сетке или по полярной сетке.\n
           ...
           \en Parameters of duplication by Cartesian grid or polar grid.\n
               ...
               false - dt_Grid, true - dt_Polar.\n
               The original solid locate in the center of the grid. \ n
...
protected:
  ...
  MbVector3D    axis2;        ///< \ru Направление размножения (dt_Grid), направление оси вращения (dt_Polar). \en Direction of duplication (dt_Grid), direction of axis of ratation (dt_Polar).
  ...
  MbCartPoint3D center;       ///< \ru Центр локальной системы координат (и точка приложения оси вращения в случае подярной системы). \en Origin of the coordinate system.
public:
