...
public:  
  ...
  */
  MbExactionSurface( const MbCurve3D & cr, const MbSpine & sp, 
                     const MbVector3D & n0, const MbVector3D & n1, double ang0,
                     double ang1, bool sameCurve );
...
private:
          ...
          void    AddTangent1( MbVector3D & ) const;
