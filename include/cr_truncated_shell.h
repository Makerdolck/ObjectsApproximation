...
private :
  SArray<MbItemIndex> selIndices; ///< \ru Идентификаторы выбранных граней усекаемой оболочки. \en Identifiers of selected faces of the shell being truncated. 
...
public:
  ...
  virtual bool        CreateShell( MbFaceShell *& shell, MbeCopyMode sameShell, 
          ...
          void        SetSelIndices( const SArray<MbItemIndex> & selInds );
