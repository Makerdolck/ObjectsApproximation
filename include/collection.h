...
private:
  ...
  std::vector<double>             escorts;     ///< \ru Множество значений. \en Set of datas. 
...
public:
  ...
  // \ru Создать полигональный объект - упрощенную копию данного объекта. \en Create a polygonal object - a simplified copy of the given object. 
          ...
          void    CreateGridsByElements( RPArray<MbGrid> & grids ) const;
          ...
          void    CreateGridsBySegments( RPArray<MbGrid> & grids ) const;
  ...
  /** \ru \name Общие функции коллекции.
      ...
      \{ */
          ...
          /// \ru Выдать количество значений. \en Get count of datas. 
