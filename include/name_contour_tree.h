...
/** \brief \ru Дерево именованых контуров.
           \en The tree of named contours. \~
  \details \ru Дерево именованых контуров.\n
           \en The tree of named contours.\n \~
  \ingroup Names
*/
// ---
...
private:
  ...
  bool                        intersectChildren;  // \ru Пересекаются ли внутрение контуры \en Are inner contours intersect
public:
...
public:
  ...
  /// \ru Провеить группы контуров на непересечение. \en Check groups of contours for absence of intersection. 
  ...
  // \ru Пересекаются ли внутрение контуры \en Are inner contours intersect
...
/** \brief \ru Выдать самый большой контур.
  ...
  \return \ru Возращает указатель на найденный контур или NULL.
