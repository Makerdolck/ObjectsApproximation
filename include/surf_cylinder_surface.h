...
public:
  ...
  // \ru Определениe точки пересечения цилиндрической поверхности и кривой. \en Determination of intersection point of cylindrical surface and curve. 
  ...
  // \ru Определениe точки касания цилиндрической поверхности и кривой. \en Determination of tangency point of cylindrical surface and curve. 
  ...
  /** \ru \name Функции цилиндрической поверхности
      ...
      \{ */ 
          ...
          /// \ru Изменение высоты. \en Change height. 
          void    SetHeight( double h ) { height = h; SetDirtyGabarit(); } 
          /// \ru Высота цилиндра. \en Height of cylinder. 
