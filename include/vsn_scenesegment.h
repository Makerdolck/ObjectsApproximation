...
public:
  ...
  */
  ...
  /** \brief \ru Специальный конструктор.
             \en Special constructor. \~ 
    \param[in] pDescriptor - \ru Описание сцены.
                             \en Scene description. \~
    \param[in] segment - \ru Сегмент сцены.
                         \en Scene segment. \~
    \param[in] bCommonSegment - \ru Общий сегмент.
                                \en Common segment. \~
  */
...
public:
  /// \ru Вернуть идентификатор сегмента. \en Returns segment identifier. \~
  uint GetId() const;
  ...
  */
  ...
  /** \brief \ru Является ли сегмент root-сегментом.
             \en Checks if segment is root-segment. \~ 
  ...
  */
  ...
  /** \brief \ru Есть ли у сегмента ViewObject3D.
             \en Checks if segment has ViewObject3D. \~ 
    \return \ru True, если в сегменте есть ViewObject3D.
            \en True if segment has ViewObject3D. \~
  */
  ...
  */
  ...
  /// \ru Установить материал. \en NOT TRANSLATED \~
  ...
  /** \brief \ru Вернуть копию сегмента.
             \en Returns copy of segment. \~ 
    \param[in] pDescriptor - \ru Описание сцены.
                             \en Scene description. \~
    \param[in] bCommonSegment - \ru Общий ли сегмент.
                                \en Checks if segment is common segment. \~
    \return \ru Сегмент сцены.
            \en Scene segment. \~
  */
  SceneSegment* Duplicate( SceneDescriptor* pDescriptor, bool bCommonSegment ) const;

  /// \ru Вернуть признак видимости сегмента. \en True if segment is visible. \~
  ...
  */
  ...
  /// \ru Вернуть признак самостоятельного создания ViewObject3D. \en Returns flag for independent creation of ViewObject3D. \~
  bool IsIndependentCreationObject3D() const;

  /** \brief \ru Установить признак автоматического создания ViewObject3D.
             \en Sets flag for automatic creation of ViewObject3D. \~ 
...
public:
  ...
  */
  ...
  /** \brief \ru Создать и вставить в указанную позицию новый сегмент с указанными данными.
             \en Creates and inserts to defined position a new segment with given data. \~ 
    \param[in] index - \ru Индекс позиции.
                       \en Positon index. \~
    \param[in] pSegmentData - \ru Данные сегмента графа сцены.
                              \en Scene graph segment data. \~
  ...
  */
  ...
  /** \brief \ru Создать ViewObject3D для этого сегмента.
             \en Creates ViewObject3D for this segment. \~ 
    \param[in] shaderId - \ru Идентификатор шейдера.
                          \en Shader identifier. \~
    \return \ru True, если ViewObject3D создан.
            \en True if ViewObject3D is created. \~
  */
  bool CreateViewObject3D( GLuint shaderId = 0 );

  /// \ru Удалить ViewObject3D этого сегмента. \en Removes ViewObject3D for this segment. \~
  ...
  */
  ...
  /** \brief \ru Установить ссылку в этот сегмент.
             \en Sets reference in this segment. \~ 
    \param[in] pRef - \ru Cегмент ссылки графа сцены.
...
private:
  VSN_DECLARE_PRIVATE(SceneSegment)
};
