...
public:
  ...
  /// \ru Получить замкнутость функции. \en Get the closedness of a function. 
  virtual bool    IsClosed() const = 0;
  /// \ru Установить замкнутость функции. \en Set the closedness of a function. 
  ...
  /** \brief \ru Вычислить значение и производные для заданного параметра.
    ...
    \param[out] thr - \ru Третья производная по t, если не ноль.
                      \en Tyhird derivative with respect to t, if not NULL. \~
    \ingroup Curves_3D
  */
  ...
  /// \ru Установить значение для параметра t. \en Set the value for the pdrdmeter t. 
