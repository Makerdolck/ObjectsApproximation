...
public:
  ...
  virtual void DrawMesh( const MbMesh * ms, int R, int G, int B ) = 0;
  /// \ru Отрисовать полигон. \en Draw a polygon. 
  virtual void DrawPolygon( const MbPolygon3D * polygon, int R, int G, int B ) = 0;
  /// \ru Отрисовать трехмерную точку. \en Draw a three-dimensional point. 
  virtual void DrawPoint( const MbCartPoint3D * gi, int R, int G, int B ) = 0;
  /// \ru Отрисовать трехмерный отрезок. \en Draw a three-dimensional segment. 
  virtual void DrawLine( const MbCartPoint3D & q1, const MbCartPoint3D & q2, int R, int G, int B ) = 0;
  /// \ru Отрисовать полилинию. \en Draw a polyline. 
  virtual void DrawPolyline( SArray<MbCartPoint3D> & points, int R, int G, int B ) = 0;
  /// \ru Отрисовать трехмерный отрезок. \en Draw a three-dimensional segment. 
  virtual void DrawLine( const MbCartPoint3D & p, const MbVector3D & v, int R, int G, int B ) = 0;
  /// \ru Отрисовать трехмерный отрезок. \en Draw a three-dimensional segment. 
  virtual void DrawLine( const MbFloatPoint3D & q1, const MbFloatPoint3D & q2, int R, int G, int B ) = 0;
  /// \ru Отрисовать участок трехмерной кривой. \en Draw a piece of a three-dimensional curve. 
  virtual void DrawCurve( const MbCurve3D & curve, double t1, double t2, int R, int G, int B ) = 0; 
  /// \ru Отрисовать часть двумерной кривой на плоскости. \en Draw a piece of a two-dimensional curve on a plane. 
  virtual void DrawCurve( const MbCurve & curve, const MbPlacement3D & place, double t1, double t2, int R, int G, int B ) = 0; 
  ...
  virtual void DrawPoint( const MbCartPoint * gi, int R, int G, int B, const MbMatrix3D & from ) = 0;
  /// \ru Отрисовать двумерную точку. \en Draw a two-dimensional point. 
  virtual void DrawPoint( const MbCartPoint * gi, int R, int G, int B ) = 0;
  /// \ru Отрисовать двумерный отрезок. \en Draw a two-dimensional segment. 
  virtual void DrawLine( const MbCartPoint & q1, const MbCartPoint & q2, int R, int G, int B, const MbMatrix3D & from ) = 0; 
  /// \ru Отрисовать двумерный отрезок. \en Draw a two-dimensional segment. 
  virtual void DrawLine( const MbCartPoint & q1, const MbCartPoint & q2, int R, int G, int B ) = 0;
  /// \ru Отрисовать топологический объект. \en Draw a topological object. 
  virtual void DrawItem( const MbTopItem * ti, int R, int G, int B ) = 0;
  /// \ru Отрисовать ребро. \en Draw an edge. 
  virtual void DrawEdge( const MbEdge * edge, int r, int g, int b, bool drawVerts ) = 0;
  ...
  virtual void PutCube( const MbCube & gab, bool bDrawRed = true ) = 0;
  /// \ru Отрисовать систему координат. \en Draw a coordinate system. 
  virtual void DrawPlacement3D( const MbPlacement3D & place, double lenAxes ) = 0;
  ...
  virtual void DrawItem( const MbCurve * curve, const MbSurface * surface, int R, int G, int B ) = 0;
  ...
  virtual void DrawPoint( const MbSurface & surface, const MbCartPoint & uv, int R, int G, int B ) = 0;
  ...
  virtual void DrawPoints( const MbSurface & surface, const SArray<MbCartPoint> & uvArr, int R, int G, int B ) = 0;
  ...
  virtual void DrawPoints( const MbCurve3D & curve, const SArray<double> & tArr, int R, int G, int B ) = 0;
  /// \ru Отрисовать массив 3d-точек. \en Draw an array of 3D-points. 
  virtual void DrawPoints( const SArray<MbCartPoint3D> & pnts, int R, int G, int B ) = 0;
  /// \ru Отрисовать триангуляцию. \en Draw a triangulation. 
  virtual void PutGrid( const MbGrid & grid, int R, int G, int B ) = 0;
  ...
  virtual void PutPlanarGrid( MbPlanarGrid & grid, const MbPlacement3D & place, int R, int G, int B ) = 0;
...
////////////////////// \en Drawing of three-dimensional objects. ////////////////////////// 
  ...
  */
  ...
  /** \brief \ru Отрисовать полигональный геометрический объект.
    ...
    \ingroup Drawing
  */
  static void DrawMesh( const MbMesh * ms, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать полигон.
    ...
    \ingroup Drawing
  */
  static void DrawPolygon( const MbPolygon3D * polygon, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать трехмерную точку.
    ...
    \ingroup Drawing
  */
  static void DrawPoint( const MbCartPoint3D * gi, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать трехмерный отрезок.
    ...
    \ingroup Drawing
  */
  static void DrawLine( const MbCartPoint3D & q1, const MbCartPoint3D & q2, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать полилинию.
    ...
    \ingroup Drawing
  */
  static void DrawPolyline( SArray<MbCartPoint3D> & points, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать трехмерный отрезок.
    ...
    \ingroup Drawing
  */
  static void DrawLine( const MbCartPoint3D & p, const MbVector3D & v, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать трехмерный отрезок.
    ...
    \ingroup Drawing
  */
  static void DrawLine( const MbFloatPoint3D & q1, const MbFloatPoint3D & q2, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать участок трехмерной кривой.
    ...
    \ingroup Drawing
  */
  static void DrawCurve( const MbCurve3D & curve, double t1, double t2, int R, int G, int B ); 
  ...
  /** \brief \ru Отрисовать часть двумерной кривой на плоскости.
    ...
    \ingroup Drawing
  */
  static void DrawCurve( const MbCurve & curve, const MbPlacement3D & place, double t1, double t2, int R, int G, int B ); 
...
////////////////////// \ru Отрисовка двумерных объектов. /////////////////////////// \en Drawing of two-dimensional objects. /////////////////////////// 
  ...
  */
  ...
  /** \brief \ru Отрисовать двумерную точку.
    ...
    \ingroup Drawing
  */
  static void DrawPoint( const MbCartPoint * gi, int R, int G, int B, const MbMatrix3D & from );
  ...
  /** \brief \ru Отрисовать двумерную точку.
    ...
    \ingroup Drawing
  */
  static void DrawPoint( const MbCartPoint * gi, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать двумерный отрезок.
    ...
    \ingroup Drawing
  */
  static void DrawLine( const MbCartPoint & q1, const MbCartPoint & q2, int R, int G, int B, const MbMatrix3D & from ); 
  ...
  /** \brief \ru Отрисовать трехмерный отрезок.
    ...
    \ingroup Drawing
  */
  static void DrawLine( const MbCartPoint & q1, const MbCartPoint & q2, 
                           int R, int G, int B );
...
////////////////////////// \ru Отрисовка топологических объектов. ////////////////// \en Drawing of topological objects. ////////////////// 
  ...
  /** \brief \ru Отрисовать топологический объект.
    ...
    \ingroup Drawing
  */
  static void DrawItem( const MbTopItem * ti, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать ребро.
    ...
    \ingroup Drawing
  */
  static void DrawEdge( const MbEdge * edge, int R, int G, int B, bool drawVerts );
...
////////////////////// \ru Отрисовка вспомогательных объектов. ///////////////////// \en Drawing of assisting items. ///////////////////// 
  ...
  */
  ...
  /** \brief \ru Отрисовать габаритный куб в текущем окне.
    ...
    \ingroup Drawing
  */
  static void PutCube( const MbCube & gab, bool bDrawRed = true );
  ...
  \ingroup Drawing
  */
  static void DrawPlacement3D( const MbPlacement3D & place, double lenAxes );
...
////////// \ru Отрисовка объектов в пространстве параметров поверхности. /////////// \en Drawing of objects in a surface parameter space. /////////// 
  ...
  /** \brief \ru Отрисовать двумерную кривую на поверхности.
    ...
    \ingroup Drawing
  */
  static void DrawItem( const MbCurve * curve, const MbSurface * surface, int R, int G, int B );
  ...
  */
  ...
  /** \brief \ru Отрисовать параметрическую точку поверхности.
    ...
    \ingroup Drawing
  */
  static void DrawPoint( const MbSurface & surface, const MbCartPoint & uv, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать массив 3d-точек по массиву 2d-точек и поверхности.
    ...
    \ingroup Drawing
  */
  static void DrawPoints( const MbSurface & surface, const SArray<MbCartPoint> & uvArr, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать массив 3d-точек по массиву параметров и кривой.
    ...
    \ingroup Drawing
  */
  static void DrawPoints( const MbCurve3D & curve, const SArray<double> & tArr, int R, int G, int B );
  ...
  /** \brief \ru Отрисовать массив 3d-точек.
    ...
    \ingroup Drawing
  */
  static void DrawPoints( const SArray<MbCartPoint3D> & pnts, int R, int G, int B );
...
///////////////////////// \ru Отрисовка триангуляции. ////////////////////////////// \en Drawing of a triangulation. ////////////////////////////// 
  ...
  /** \brief \ru Отрисовать триангуляцию.
    ...
    \ingroup Drawing
  */
  static void PutGrid( const MbGrid & grid, int R, int G, int B );
  ...
  */
  ...
  /** \brief \ru Отрисовать двумерную триангуляцию.
    ...
    \ingroup Drawing
  */
  static void PutPlanarGrid( MbPlanarGrid & grid, const MbPlacement3D & place, int R, int G, int B );
                      ...
                      const Edges & edges, int eR, int eG, int eB )
{
  ...
  for ( size_t k = 0, cnt = edges.Count(); k < cnt; k++ ) {
    if ( edges[k] != NULL ) {
      edges[k]->GetCurve().CalculateWire( stepData, edgeMesh );
