...
public :
  ...
  */
  MbBezier( bool closed, const SArray<MbCartPoint> & points );
  ...
  */
  MbBezier( const SArray<MbCartPoint> & initList, bool cls, int initForm = 0 );
...
/** \} */
  ...
  */
  ...
  /** \brief \ru Инициировать кривую по контрольным точкам.
    ...
    \param[in] initList - \ru Массив характерных точек кривой.
                          \en An array of characteristic points of curve. \~
  */
...
/** \} */
 /** \ru \name Функции описания области определения кривой.
  ...
  /** \ru \name Общие функции полигональной кривой
      ...
      \{ */
  virtual size_t      GetPointsCount() const; ///< \ru Вернуть количество несовпадающих характерных точек. \en Return the number of non-coincedent characteristic points. 
