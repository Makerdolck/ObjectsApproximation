...
public :
  MbCurve *   baseCurve; ///< \ru Базовая кривая. \en The base curve. 
...
public:
  ...
  */
  ...
  MbCurve *   GetCurve() const { return baseCurve; }                
...
public:  
  ...
  */
  ...
  void        GetVerticesArray( PArray<MpVertex> & vertices ) const;        
  /// \ru Выдать массив кривых. \en Get curve array. 
  void        GetCurvesArray  ( PArray<MbCurve> & curves   ) const;         
...
public:
  ...
  */
  bool        GetPointIn( const RPArray<MbCurve> & curveList, SArray<MbCrossPoint> & cross, MbCartPoint & p, 
                          double epsilon = Math::LengthEps*METRIC_DELTA ) const;
  ...
  */
  void        GetUsedCurves( const PArray<MbCurve> & curveList, PArray<MbCurve> & usedCurves );
  ...
  */
  ...
  void        MakeContours( PArray<MbContour> & contours ) const;   
  ...
  */
  void        SetAllName( const PArray<MbCurve> & curveList, MpGraph * g );
  ...
  */
  void        SetEdgeName( const PArray<MbCurve> & curveList );
  ...
  */
  void        SetLoopsOrientation( const PArray<MbContour> & contourArray );
...
*/
// ---
MATH_FUNC (MpGraph *) EncloseContoursBuilder( const PArray<MbCurve> & curveList, 
                                              const MbCartPoint & p,
...
*/
// ---
MATH_FUNC (MpGraph *) OuterContoursBuilder( const PArray<MbCurve> & curveList, 
                                            PArray<MbContour> & contourArray,
                                            double  accuracy, 
                                            bool    strict, 
                                            VERSION version,
...
*/
// ---
MATH_FUNC (MpGraph *) ContoursReconstructor( const PArray<MbCurve> & curveList, 
                                             MpGraph *               graph, 
                                             PArray<MbContour> & contourArray,
                                             double  accuracy, 
                                             bool    strict, 
