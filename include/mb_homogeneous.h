...
// \ru Разность p2 - p1 умножить на kk. \en Subtract p2 - p1 multiple by kk. 
// ---
inline void MbHomogeneous::Dec( const MbHomogeneous & p1, const MbHomogeneous & p2, 
                                double kk ) {
  x = ( p2.x - p1.x ) * kk;
  y = ( p2.y - p1.y ) * kk;
  w = ( p2.w - p1.w ) * kk;
...
*/
// ---
inline bool EqualVectors( const MbHomogeneous & p1, const MbHomogeneous & p2, double eps )
{
