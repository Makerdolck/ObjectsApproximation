...
/** \brief \ru Cферическая поверхность.
  ...
  \details \ru Сфера описывается радиусом radius, заданными в локальной системе координат position.\n
    ...
    Радиус сферы дожен быть больше нуля: radius>0. 
...
public:
  ...
  */
  ...
  /// \ru Конструктор по центру и рудиусу. \en Constructor by center and radius. 
...
public:
  ...
  /** \ru \name Функции конической поверхности
      ...
      \{ */
          /// \ru Дать внутрениий радиус. \en Get inner radius. 
