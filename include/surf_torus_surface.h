...
private:
  ...
  bool   vclosed;     ///< \ru Признак замкнутости по параметру v. \en An attribute of closedness in v-parameter direction. 
                      ///< \ru majorRadius == minorRadius - асцилирущее яблоко по v замкнут в -M_PI и M_PI полюса, \en MajorRadius == minorRadius - oscillatory apple is closed in v direction in -M_PI and M_PI poles, 
