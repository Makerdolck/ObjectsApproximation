...
/** 
  ...
  \brief \ru Утилита расчета параметров пересечения и близости тел.
    Интерфейсная утилита работы с аппаратом расчетов пересечения и близости объектов
         \en Utility for calculation of intersection and proximity parameters of solids.
    Interface utility for working with mechanisms of calculation of intersection and proximity parameters of solids. \~
*/
//////////////////////////////////////////////////////////////////////////////////////////
...
class MATH_CLASS MbCollisionDetectionUtility 
{
  ...
  static cdet_query_result  defaultQuery;
...
public: // The members below are deprecated
  cdet_result InterferenceDetect( FDPArray<MbHRepSolid> &, MbCollisionFaceArr * ) const;  
  cdet_result InterferenceDetect( MbCollisionFaceArr * ) const;
