...
public:
  ...
  MbFloatPoint() { x = y = 0; }
  /// \ru Конструктор. \en Constructor. 
  MbFloatPoint( double xx, double yy  ) : x( D2F(xx ) ), y( D2F(yy ) ) {}
  /// \ru Конструктор. \en Constructor. 
  explicit MbFloatPoint( const MbCartPoint  & p ) : x( D2F(p.x) ), y( D2F(p.y) ) {}
  /// \ru Конструктор. \en Constructor. 
  explicit MbFloatPoint( const MbVector & p ) : x( D2F(p.x) ), y( D2F(p.y) ) {}
  /// \ru Конструктор. \en Constructor. 
...
// ---
inline bool EqualPoints( const MbFloatPoint & p1, const MbFloatPoint & p2, double eps ) {
