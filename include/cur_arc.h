...
protected :
  ...
  bool        circle;   ///< \ru Флаг, указывающий является объект окружностью или дугой (circle == true - окружность) . \en Whether the object is a circle or an arc (circle == true - a circle) . 
...
public :
  ...
  virtual void        GetPointsByEvenLengthDelta( size_t n, SArray<MbCartPoint> & pnts ) const; // \ru Выдать n точек кривой с равными интервалами по длине дуги \en Get n points of curves equally spaced by the arc length 
  ...
  */
  ...
  /** \brief \ru Заменить точку дуги.
    ...
    \param[in] pnt - \ru Новая точка.
                     \en A new point. \~
  */
          void        SetLimitPoint( ptrdiff_t number, MbCartPoint & pnt ); // \ru Заменить точку дуги \en Replace the arc point 
