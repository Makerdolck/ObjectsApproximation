...
private:
          ...
          double  StepD( bool isU, double u, double v, double sag, bool checkAngle, double angle ) const;
          double  StepDPlus( bool isU, double u, double v, double sag, bool checkAngle, double angle ) const;
          double  DeviationStep( bool isU, double u, double v, double angle ) const;
          double  DeviationStepPlus( bool isU, double u, double v, double angle ) const;
  ...
  inline  void    CheckParam( const SArray<double> & knots, const ptrdiff_t& degree, const bool& closed, double & t ) const; 
          ...
          void    GetVertecisRects( const MbVector3D & direction, bool u, 
                                    std::vector<std::pair<c3d::NumberPair, c3d::NumberPair> > & vertecesRects ) const;
