...
/** \brief \ru Плоскость.
           \en A plane. \~
  \details \ru Плоскость распологается в координатной плоскости XY местной систены координат position. \n
...
public:
      ...
      \{ */
          ...
          /** \brief \ru Инициализация по системе координат и расстоянию.
            ...
            \details \ru Инициализация плоскости системой координат init co сдвигом на 
              расстояние distanse в направлении нормали (оси Z).
          ...
          */
          ...
          /** \brief \ru Инициализация по двум прямым.
            ...
            \details \ru Инициализация по двум прямым.  
              В случа успеха нициализирует плоскость по первой прямой 
            ...
            \param[in] line1 - \ru Превая прямая
                               \en First line. \~
  ...
  virtual bool    IsPlanar() const; // \ru Является ли пверхность плоской \en Whether a surface is planar. 
  ...
  // \ru Пересечениe с поверхностью. \en Intersection with surface. 
  ...
  virtual bool    IsShift( const MbSpaceItem &, MbVector3D &, bool & ) const; // \ru Является ли объект смещением. \en Is the object a shift? 
  /** \} */
  ...
  /** \ru \name Функции плоскости
      ...
      \{ */
          ...
          */
          ...
          /** \brief \ru Подобны ли полоскости для объединения.
                     \en Whether planes are similar to merge. \~
            \details \ru Подобны ли полоскости для объединения.
                     \en Whether planes are similar to merge. \~
