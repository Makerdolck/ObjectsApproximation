...
//------------------------------------------------------------------------------
/** \brief \ru Mодифицировать тело по матрице.
           \en Modify a solid by the matrix. \~
  \details \ru Выполнить трансформацию копии исходного тела по матрице, расчитанной по габаритному кубу. \n
...
/** \brief \ru Собрать грани оболочки для методов прямого моделирования.
  ...
  \details \ru Функция собирает грани оболочки для методов прямого моделирования: \n
    ...
    The cylindrical, toroidal, spherical nonperiodic, and fillet faces are collect to purify way. \n \~
  ...
  \return \ru Возвращает код результата дейсевий.
...
//------------------------------------------------------------------------------
/** \brief \ru Mодифицировать оболочку методами прямого моделирования.
           \en Modify a shell by the methods of direct modeling. \~
