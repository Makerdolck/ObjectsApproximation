...
/** \brief \ru Двумерная кривая, координатные функции которой заданы в символьном виде.
  ...
  \details \ru Координатные функции кривой заданы в виде пользовательских функций общего параметра t. 
    Кождая ккордината кривой описана своей функцией в виде строкового выражения. 
...
private:
  ...
  std::vector<double> specialParams;  ///< \ru Перечень параметров особых точек кривой \en List of parameters of curve's singular points 
  // \ru Буферные данны для ускорения вычислений. \en Buffer data to speed up computations. 
